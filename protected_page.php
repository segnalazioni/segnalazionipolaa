                                    ...
                                    <tr>
                                        <td height="70%">
                                            <div style="width: 100%; height: 100%; position: relative;">
                                                ...
                                                <paper-fab class="gpsfab" icon="image:camera-alt" style="position:absolute; right:100px; margin-left:0; --paper-fab-mini:true; bottom:-28px; background-color:#e1382d;"></paper-fab>
